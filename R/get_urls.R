...
get_urls <- function(..., key. = NULL)
{
  dictionary <- list(
    ...
    path__wfs = "fb/wfs",
    path__wfs_data = "<path__wfs>/data/senstadt",
    path__wfs_geometry = "<path__wfs>/geometry/senstadt",
    path__wms = "fb/wms",
    path__wms_data = "<path__wms>/wms/data/senstadt",
    ...
    href_wfs_base = "<base>/<path__wfs>",
    href_wfs_data  = "<base>/<path__wfs_data>/<id>?<query__wfs>",
    href_wfs_geometry  = "<base>/<path__wfs_geometry>/<id>?<query__wfs>",
    href_wfs_url  = "<url>?<query__wfs>",
    href_wws_base = "<base>/<path__wms>",
    href_wms_data = "<base>/<path__wms_data>/<id>?<query__wms>",
